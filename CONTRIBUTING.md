...
```bash
$ git clone git@github.com:username/dcolor.git
```

This will clone your fork to your current path in a directory named `dcolor`.
...
```bash
$ cd dcolor
$ git remote add upstream git@github.com:ibm-dojo/dcolor.git
$ git fetch upstream
```
